    ...
    >
      <div className="mt-8">
        ...
        >
          ...
          <motion.div
            className="absolute flex -top-11 right-0"
            initial="hidden"
          ...
          >
            ...
            >
              <FaExternalLinkAlt className="text-3xl text-ternary-dark dark:text-ternary-light mx-2 hover:text-teal-950 hover:-translate-y-1 transition-all duration-300" />
            </a>
          </motion.div>
        </div>
      </div>
